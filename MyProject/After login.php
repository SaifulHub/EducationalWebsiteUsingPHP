<?php
	echo "<script>alert('Thanks for logging in.')</script>";
	include 'config.php';
...
<html lang="en">
	...
	<body>
		...
		<nav class="navbar">
			<div class="head">
				<div class="logo"><a>Learn<span>Academy</span></a> <span class = "premium">Premium</span></div>
				<div class="options">
					<a href="#home">Home</a>
			...
			<div class="head">
					...
					<h2> Choose your Subject </h2>
						<div class="options">
							...
							<a href="Theorems.php">Theorems for Mathematics</a>
